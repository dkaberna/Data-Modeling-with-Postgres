...
# CREATE TABLES
#This will be our fact table - records in log data associated with song plays i.e. records with page
...
song_table_create = """CREATE TABLE IF NOT EXISTS songs (song_id varchar NOT NULL PRIMARY KEY, title varchar, artist_id varchar, year numeric, duration float);"""
